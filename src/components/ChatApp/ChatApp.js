        ...
        <div class="flex h-screen overflow-hidden">
            <div class="w-1/4 bg-white border-r border-gray-300">
                ...
                <div class="overflow-y-auto h-screen p-3 mb-9 pb-20">
                    <div class="flex items-center mb-4 cursor-pointer hover:bg-gray-100 p-2 rounded-md">
                        ...
                        <div class="flex-1">
                            <h2 class="text-lg font-semibold">Fida Khaplu</h2>
                    ...
                    <div class="flex items-center mb-4 cursor-pointer hover:bg-gray-100 p-2 rounded-md">
                        ...
                        <div class="flex-1">
                            <h2 class="text-lg font-semibold">Ehtasham</h2>
                            <p class="text-gray-600">Hello Admin ?? Wasssup</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center mb-4 cursor-pointer hover:bg-gray-100 p-2 rounded-md">
                        ...
                        <div class="flex-1">
                            <h2 class="text-lg font-semibold">Bilal</h2>
                    ...
                    <div class="flex items-center mb-4 cursor-pointer hover:bg-gray-100 p-2 rounded-md">
                        ...
                        <div class="flex-1">
                            <h2 class="text-lg font-semibold">Wajaht</h2>
                    ...
                    <div class="flex items-center mb-4 cursor-pointer hover:bg-gray-100 p-2 rounded-md">
                        ...
                        <div class="flex-1">
                            <h2 class="text-lg font-semibold">Hamza </h2>
            ...
            <div class="flex-1">
                <header class="bg-white p-4 text-gray-700">
                    <h1 class="text-2xl font-semibold">Wajahat</h1>
                </header>
                ...
                <div class="h-screen overflow-y-auto p-4 pb-36">
                    <div class="flex mb-4 cursor-pointer">
                        ...
                        <div class="flex max-w-96 bg-white rounded-lg p-3 gap-3">
                            <p class="text-gray-700">Hey Sohaib, how's it going?</p>
                        </div>
                    </div>

                    <div class="flex justify-end mb-4 cursor-pointer">
                        <div class="flex max-w-96 bg-indigo-500 text-white rounded-lg p-3 gap-3">
                            <p>Hi TeamLead! I'm good, just finished a great book. How about you?</p>
                        </div>
