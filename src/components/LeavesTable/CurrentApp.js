...
function CurrentApp() {
    ...
    return (
        <>
            <TitleCard title="Current Application" topMargin="mt-2" TopSideButtons={<TopSideButtons />}>
                    ...
                    <table className="table w-full">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Ali</td>
                                <td>02-03-2024</td>
                                <td className="flex items-center"><span className=" mr-2">Sick</span><button className="btn btn-square"><ViewIcon className="w-5" /></button></td>
